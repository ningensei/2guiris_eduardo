<?php echo $header; ?>
    ...
    <div class="page-header">
        <div class="page-title">
            ...
            <span>Desde aquí se pueden agregar editar o eliminar las partituras</span>
        </div>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped">
                        <thead>
                            <tr>
                                ...
                                <!-- <?php echo $this->admin->th('archivo', 'Archivo', true);?> -->
                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo alternator('odd', 'even');?>">
                                ...
                                <!-- <?php echo $this->admin->td($row->archivo);?> -->
                    ...
                    <div class="row">
                        <div class="table-footer">
                            <div class="col-md-12 text-center">
                                <a class="btn btn-primary" href="<?php echo $route;?>/add">Agregar nueva partitura</a>
                            </div>
                            <div class="col-md-6">
                                <?php echo $pages; ?>
                            </div>
