<?php echo $header; ?>
    ...
    <div class="page-header">
        <div class="page-title">
            ...
            <span>Desde aquí se pueden agregar editar o eliminar las <b>distinciones</b></span>
        </div>
                    ...
                    <div class="row">
                        <div class="table-footer">
                            <div class="col-md-12 text-center">
                                <a class="btn btn-primary" href="<?php echo $route;?>/add">Agregar nueva distinción</a>
                            </div>
                            <div class="col-md-6">
                                <?php echo $pages; ?>
                            </div>
