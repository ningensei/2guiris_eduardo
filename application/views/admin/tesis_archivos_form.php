<?php echo $header;?>
    ...
    <div class="page-header">
        <div class="page-title">
            ...
            <span>Subir una archivo de tesis al servidor</span>
        </div>
    </div>
            ...
            <div class="widget box">
                <div class="widget-content">
                    <form id="formEdit" class="form-horizontal row-border" method="post" action="<?php echo $route;?>/save" enctype="multipart/form-data" onsubmit="return validar();">
                            ...
                            <?php echo $this->admin->file('archivo', 'Archivo', '', isset($row->archivo) ? $row->archivo : '', '/uploads/tesis/' . (isset($row->id) ? $row->id : '') .'/', $required=true);?>
