<?php echo $header; ?>
    ...
    <div class="page-header">
        <div class="page-title">
            ...
            <span>Desde aquí se pueden agregar editar o eliminar las <b>composiciones</b> al listado</span>
        </div>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped">
                        <thead>
                            <tr>
                                ...
                                <?php echo $this->admin->th('dispositivo', 'Dispsitivo', true);?>
                                <?php echo $this->admin->th('lugar', 'Lugar', true);?>
                                <?php echo $this->admin->th('ano', 'Año', true);?>
                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo alternator('odd', 'even');?>">
                                ...
                                <?php echo $this->admin->td($row->dispositivo);?>
                                <?php echo $this->admin->td($row->lugar);?>
                                <?php echo $this->admin->td($row->ano);?>
                    ...
                    <div class="row">
                        <div class="table-footer">
                            <div class="col-md-12 text-center">
                                <a class="btn btn-primary" href="<?php echo $route;?>/add">Agregar nueva composición</a>
                            </div>
                            <div class="col-md-6">
                                <?php echo $pages; ?>
                            </div>
